...
const emit = defineEmits<{
  added: [ingredient: { ingredient_id: string; ingredient_name: string; quantity: number | null; unit: string | null; note: string | null }];
}>();
...
function addIngredient() {
  ...
  // Emit the ingredient data to parent (staged locally)
  emit('added', {
    ingredient_id: selectedIngredient.value.id,
    ingredient_name: selectedIngredient.value.canonical_name,
